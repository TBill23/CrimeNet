...
public class SearchFrame extends JFrame {
	...
	private JButton visualizeButton = new JButton("Visualize Network"); //Πήλκτρο Find για εύρεση υπόπτου
	...
	public SearchFrame (Registry r) {
		...
		someSuspects=r.getSuspects(); // Από την registry, παίρνω μόνο τους υπόπτους
		...
		// Δήλωση ButtonListener και προσθήκη του στα πλήκτρα
